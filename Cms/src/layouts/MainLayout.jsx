...
import { LayoutDashboard, Tag, Package, Image as ImageIcon, ShoppingCart, Users, Settings as SettingsIcon, LogOut, MessageSquare } from 'lucide-react';
...
export default function MainLayout({ session, setSession }) {
  ...
  const menuItems = [
    ...
    { path: '/chatbot', label: 'Chatbot (FAQ)', icon: MessageSquare },
